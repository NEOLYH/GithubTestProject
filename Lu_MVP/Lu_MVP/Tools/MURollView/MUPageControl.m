...
@interface MUPageControl ()<MUPageControlDelegate>

@end

@implementation MUPageControl
...
-(void)setCurrentPage:(NSInteger)currentPage{
    ...
    if([self.delegate respondsToSelector:@selector(pageControl:selectedItem:)])
    {
        [self.delegate pageControl:self selectedItem:currentPage];
    }
