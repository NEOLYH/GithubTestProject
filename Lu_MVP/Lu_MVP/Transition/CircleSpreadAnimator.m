...
#import "CircleSpreadAnimator.h"

@interface CircleSpreadAnimator ()<CAAnimationDelegate>
...
@implementation CircleSpreadAnimator
...
- (void)lu_setToAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    UIBezierPath * startCycle = [UIBezierPath bezierPathWithArcCenter:self.startPoint radius:self.startRadius startAngle:0 endAngle:M_PI_2 clockwise:YES];
    ...
    UIBezierPath * endCycle = [UIBezierPath bezierPathWithArcCenter:self.startPoint radius:radius startAngle:0 endAngle:M_PI_2 clockwise:YES];
    ...
    [maskLayer addAnimation:maskLayerAnimation forKey:@"lu_path"];
}
...
- (void)xw_interactiveTransitionWillBeginTimerAnimation:(LUInteractiveTransition *)interactiveTransition{
